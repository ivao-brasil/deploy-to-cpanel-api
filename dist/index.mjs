...
/* harmony export */   "Pd": () => (/* binding */ HTTPResponseError),
/* harmony export */   "XQ": () => (/* binding */ CPanelError),
/* harmony export */   "$B": () => (/* binding */ DeploymentSetupError),
/* harmony export */   "mK": () => (/* binding */ DeploymentCreateError)
/* harmony export */ });
...
class DeploymentSetupError extends Error {
	constructor(error) {
		super(error);
	}
}

class DeploymentCreateError extends Error {
	constructor(error) {
		super(error);
	}
}
